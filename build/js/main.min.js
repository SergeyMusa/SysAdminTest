...
function sortStrArr(arr) {
  //сотрируем строковый массив
  arr.sort();
  return arr;
}

function sortNumArr(arr) {
  //сотрируем числовой массив
  arr.sort(compareNum);
...
var myArray = [1, 10, 2, 14, 20, 44, 4, 7];
...
function showTest(obj) {
  ...
  randomArr(testNumberArr); // console.log("--------------");
  // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  var x = testNumberArr; // check break in number question json, else err
  ...
  if (x[x.length - 1] !== x.length) {
    ...
    console.log("\u043E\u0436\u0438\u0434\u0430\u0435\u043B\u0441\u044F \u043D\u043E\u043C\u0435\u0440:".concat(x.length, ", \u0430 \u043F\u043E\u043B\u0443\u0447\u0435\u043D:").concat(x[x.length - 1]));
  }
  ...
  for (var i = 0; i < x.length; i++) {
    ...
    var variantAnswer = questions[x[i]].answers;
