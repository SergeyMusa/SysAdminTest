...
var Anketa = {
  ...
  start: function start() {
    ...
    if (Anketa.autoriseBaner === true) {
      checkerAutorise.addEventListener('click', function (event) {
        Anketa.togleInput();
        event.target.remove();
      });
    } else {
  ...
  togleInput: function togleInput() {
    ...
    Anketa.btnCheckTest.disabled = true; // btnCheckTest.disabled = false;
...
Anketa.start(); // //  тренировочный объект
// const myObject = {
//     'n1': '1',
//     'n2': 12,
//     'n3': 3,
...
Anketa.btnStartTest.addEventListener('click', function (event) {
  ...
  Anketa.btnCheckTest.disabled = false; // event.target.remove();
