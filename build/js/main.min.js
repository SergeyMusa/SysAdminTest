...
var section = document.querySelector("#top"); // const questionsNumber = 2;
// userButtonTest.disabled = false;
...
function populateHeader(obj) {
  var myH1 = document.createElement("h1.test");
  myH1.textContent = obj["jTestSysadmin"];
  header.appendChild(myH1);
  var user = document.createElement("p");
  user.textContent = "\u0422\u0435\u0441\u0442 \u043F\u0440\u043E\u0445\u043E\u0434\u0438\u0442: ".concat(localStorage.getItem('user'), " \u0438\u0437 \u043E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438: ").concat(localStorage.getItem('org'), ", \u043F\u043E\u043F\u044B\u0442\u043A\u0430 \u2116").concat(localStorage.getItem('count') || '0'); //- let intervieweeName = user.textContent =localStorage.getItem('user');
...
function checkTest() {
  ...
  console.log('isEqual_', equal); // for (var i = 1; i < 4; i++) {
  //     // for (let [key, value] of answerRight) {
  //     console.log(i);
  // };
  // for (var i = 1; i < 5; i++) {
  ...
  console.log('al=', Object.keys(answerList).length); // console.log(42, key, "z", value);
  // };
