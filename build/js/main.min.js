...
checkerAutorize.addEventListener('click', function (event) {
  ...
  timeBeginTest = getTime(); // надо убрать в функции вывод в консоль и сделать заносить значение в объект Анкета
  // console.log("timeBeginTest_"+timeBeginTest);
});
checkerOneAll.addEventListener('click', function (event) {
