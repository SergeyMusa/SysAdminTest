...
function doTest(obj, how) {
  ...
  console.log(randomQuestions); // -------do there-------
  ...
  var position = document.querySelector('#top');
  var variantAnswer = '';
  myArticle.setAttribute("class", "test"); // answers.answerList = document.createElement("div");
  ...
  if (how === 'All') {
    ...
    for (var i = 0; i < randomQuestions.length; i++) {
      ...
      testAnswer.textContent = "\u041F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u044B\u0439 \u043E\u0442\u0432\u0435\u0442: ".concat(questions[randomQuestions[i]].right, " - ").concat(questions[randomQuestions[i]].justification); // position.appendChild(testNumber);
      // console.log(i + 1);
  ...
  function showQuestion(numberQuestion) {
    for (var numberAnswer = 1; numberAnswer < variantAnswer.length; numberAnswer++) {
      ...
      radioAnswer.innerHTML = "\n                <input type='radio' name='answer".concat(numberQuestion, "' value='").concat(numberAnswer, "' onClick='onChangeButtonValue(").concat(numberQuestion, ", ").concat(numberAnswer, ")'> \n                <label for='").concat(numberAnswer, "'>").concat(variantAnswer[numberAnswer], "</label>"); // `<input type='radio' name='answer${x[i]}' value='${j}' onClick='onChangeButtonValue(${x[i]}, ${j})'> <label for='${j}'>${variantAnswer[j]}</label>`;

      answers.answerList.appendChild(radioAnswer); // console.log(radioAnswer);//.textContent);
