...
function isEqual(answerList, answerListTrue) {
  ...
  var evaluation = 0;
  var evaluationPoor = 51;
  var evaluationGood = 75;
  ...
  var itog = evaluation > evaluationPoor ? 'Good' : 'Poor';
  console.log(answerAmount, answerRight, evaluation, '%', itog); //!!!!!!!!!!!!!!!!!

  var section = document.querySelector("#bottom");
  var testRez = document.createElement("h4"); //const testTexst = document.createTextNode("Ответ:, rez");
...
function checkTest() {
  ...
  var equal = isEqual(answerList, answerListTrue);
  console.log('isEqual_', equal);
  testCount(); // localStorage.setItem(i, '0');
  // console.log("ls_", j, " ", localStorage.getItem(j));
  //   localStorage.getItem(j) 
  //

  var LS = _objectSpread({}, localStorage);

  console.log(LS); //gulpLodash.
  // !!!!!!!!!!!!! делаю тут
}
