...
// console.log(add(1, 2));
console.log(_lodash["default"].isEqual(1, true));
"use strict";
...
var userFunction = function userFunction() {
  // alert( 'чекбокс выключён1' );
  ...
  console.log(localStorage.getItem('user') + ' ' + localStorage.getItem('org'));
  userButton.disabled = true;
...
console.log(_.isEqual(1, 2)); // формируем тест
// const doTest = () => {
...
var testCount = function testCount() {
  ...
  count = count + 1; // !!!!!!!!! исправить костыль
