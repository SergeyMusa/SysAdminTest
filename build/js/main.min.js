...
function loadJson() {
  ...
  promise.then(function (resolve) {
    ...
    console.log("\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u0430 - ".concat(resolve)); // showTest(sysAdminTest);
    // console.log(sysAdminTest);
...
Anketa.checkerAutorize.addEventListener('click', function (event) {
  togleInput();
  event.target.remove(); //-- NEW CODE
  // console.log(checkerAutorize);

  Anketa.timeBegin = getTime(); // надо убрать в функции вывод в консоль и сделать заносить значение в объект Анкета
...
Anketa.btnStartTest.addEventListener('click', function (event) {
  ...
  var user = Anketa.inputUserName.placeholder;
  var org = Anketa.inputUserOrg.placeholder;

  if (Anketa.inputUserName.value !== "" && Anketa.inputUserOrg.value !== "") {
    // userName.placeholder = "Сыкло )";
    user = "\"".concat(Anketa.inputUserName.value, "\"");
    org = "\"".concat(Anketa.nputUserOrg.value, "\"");
  }
...
function doTest(obj, how) {
  ...
  function showQuestion(i) {
    ...
    myArticle.appendChild(answers.answerList); // myArticle.appendChild(testAnswer);   // ответ
